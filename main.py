...
def load_data():
    ...
    return pd.read_csv("14042024(3.csv")
...
st.write("""
ВВП России в 2000-е годы демонстрировал стабильный рост, поддерживаемый высокими ценами на энергоносители и экспортными доходами.

В 2008 году Россия столкнулась с экономическим спадом, вызванным мировым финансовым кризисом.

В 2020 году была пандемия COVID-19 и снижение цен на энергоносители..
""")
